...
switch(user){
	default:
		...
		var dictLinks = {
			...
			'snapchat' : {'active' : true, 'link' : 'https://www.snapchat.com/add/shethzor#Look_at_me_snap!'},
			...
			'tipeeestream_donate' : {'active' : true, 'link' : 'https://www.tipeeestream.com/Shethzor#Are_you_about_to_donate?_Thanks_a_lot_<3'},
